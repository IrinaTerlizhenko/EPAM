...
public class MovieLogicTest {
    ...
    public void addMovieTestNormal() throws LogicException {
        int id = 0;
        try {
            ValidationResult result = MovieLogic.addMovie(ADD_MOVIE_NAME, ADD_DESCRIPTION, ADD_YEAR, ADD_COUNTRY, null, null);
        ...
        ValidationResult result = MovieLogic.addMovie(ADD_MOVIE_NAME_INCORRECT, ADD_DESCRIPTION, ADD_YEAR, ADD_COUNTRY, null, null);
        Assert.assertEquals(ValidationResult.NAME_INCORRECT, result);

        result = MovieLogic.addMovie(ADD_MOVIE_NAME, ADD_DESCRIPTION, ADD_YEAR_INCORRECT, ADD_COUNTRY, null, null);
        Assert.assertEquals(ValidationResult.YEAR_INCORRECT, result);

        result = MovieLogic.addMovie(ADD_MOVIE_NAME, ADD_DESCRIPTION, ADD_YEAR, ADD_COUNTRY_INCORRECT, null, null);
        Assert.assertEquals(ValidationResult.COUNTRY_INCORRECT, result);
    }

    @Test
    public void editMovieTest() throws LogicException {
        MovieLogic.addMovie(ADD_MOVIE_NAME, ADD_DESCRIPTION, ADD_YEAR, ADD_COUNTRY, null, null);
