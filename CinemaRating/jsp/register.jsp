    ...
    <body>
        <form method="POST" action="${pageContext.request.contextPath}/controller" class="form-horizontal login-form">
            ...
            <div class="form-group">
                ...
                <input id="repeat-password" type="password" name="repeat-password" class="form-control" required minlength="1" maxlength="20"
                       pattern="(\w|\d){3,20}">
            </div>
            <div class="form-group">
                ...
                <input id="email" type="email" name="email" class="form-control" value="${email}" required minlength="5" maxlength="40"
                       pattern="(\w|\d)+@\w+\.\w+"
